...
|---|---|---|---|---|---|
| `check/` | `check/readme.md` | 2026-09-04 | `openspec/specs/check/spec.md` | 2026-09-04 | 2026-09-04 |
...
| `plugins/` | `plugins/readme.md` | 2026-09-04 ⚠️ | `openspec/specs/plugins/spec.md` | 2026-09-03 ⚠️ | 2026-09-09 |
...
*Собрано 2026-09-09 скриптом `sync_context.py`*
